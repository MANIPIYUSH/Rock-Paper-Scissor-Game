...
let scoreOfUser = document.getElementById("userScoreVal");
let scoreOfBot = document.getElementById("compScoreVal");
...
function result(u,c){
     if(u === c)
     {
        ...
        win.innerText="Winner:Draw"
          ...
          user_num += 1;
          scoreOfUser.innerText = user_num;

     }else if(u ==='s' && c ==='r'){
        win.innerText ="Winner:Computer";
        comp_num += 1;
        scoreOfBot.innerText = comp_num;
